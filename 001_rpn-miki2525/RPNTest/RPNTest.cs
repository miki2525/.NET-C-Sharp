...
namespace RPNTest
{
	...
	public class RPNTest  {
		private RPNCalulator.RPN _sut;
		[SetUp]
		public void Setup() {	
            _sut = new RPNCalulator.RPN();
		}
		[Test]
		...
		public void OperatorDivision_DivideTwoNumbers_ReturnCorrectResult()
		{
		...
		[Test]
		public void OperatorBinary_ReturnCorrectResult()
		{
			var result = _sut.EvalRPN("B11001");

			Assert.That(result, Is.EqualTo(25));
		}

		[Test]
		public void OperatordDecimal_ReturnCorrectResult()
		{
			var result = _sut.EvalRPN("D25");

			Assert.That(result, Is.EqualTo(25));
		}

		[Test]
		public void OperatorHexadecimal_ReturnCorrectResult()
		{
			var result = _sut.EvalRPN("#19");
